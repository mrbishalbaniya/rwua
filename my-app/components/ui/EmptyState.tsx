    ...
    <div className="text-center py-16 px-4">
      <div className="max-w-md mx-auto">
        ...
        {onReset && (
          <button
            onClick={onReset}
            className="inline-flex items-center px-6 py-3 bg-core-blue text-white rounded-lg hover:bg-black transition-colors font-bold focus:outline-none focus:ring-2 focus:ring-core-blue focus:ring-offset-2"
          >
            {actionLabel}
          </button>
        )}
