    ...
    <article className={`bg-white rounded-lg shadow-md overflow-hidden 
      ...
      <div className="relative h-48 sm:h-64 w-full bg-gray-100">
        ...
        {imageError ? (
          ...
          <Image
            src={vacancy.image || '/images/default-vacancy.jpg'}
            alt={`Job vacancy image: ${vacancy.position}`}
            fill
      ...
      <div className="p-6">
        ...
        <div className="flex items-center text-sm text-blue-600 mb-4 space-x-4" aria-label="Job details">
          <span className="flex items-center">
            ...
            <span aria-label={`Department: ${vacancy.department}`}>{vacancy.department}</span>
          </span>
          {vacancy.deadline && (
            <span className="flex items-center">
              <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
        ...
        <div className="pt-4 border-t border-gray-200">
          <button 
            ...
            aria-label={`Apply for ${vacancy.position} position`}
