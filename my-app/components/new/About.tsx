...
interface CardState {
  ...
  isThrown: boolean;
  zIndex: number;
  noAnim?: boolean; // Flag to disable transition during silent reset
}
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-32">
          ...
          <div className="w-full lg:w-1/2">
            <h2 className="text-6xl lg:text-[65px] font-serif-impact text-core-blue leading-[0.9] tracking-tighter mb-10">
              Rural Women <br />
              <span className="text-impact-red text-nowrap italic">Upliftment Association</span>
            </h2>
              ...
              {cards.map((card) => (
                <div
                  ...
                  style={{
                    ...
                    // Updated transition logic to prevent the back-sliding animation
