...
export const ORG_MEMBERS: OrgMember[] = [
  {
    ...
    quote: (
      <>
        ग्रामीण नारी उत्थान संघ हरिपुरले विगत लामो समय देखि ग्रामीण भेगका नागरिकहरुको ज्ञान एवं शिपसाग सम्बन्धित विविध किसिमका सशक्तिकरणको कार्यलाई अगाडि बढाउादै आएको छ । लोकतन्त्रको सम्बद्र्वन र सुशासनको अभिवृद्विका लागि सामाीजक तथा नागरिक समूह एवं संगठनहरुको महत्वपुर्ण भूमिका हुन्छ । प्रजातन्त्रको विकास सगै <span className="bg-core-blue px-1 text-white">जनउत्तरदायी</span> व्यवस्थाको विकासमा बल पुग्ने हुादा यसका अति आवश्यक संयन्त्रहरु र अवलम्बन गरिएका प्रक्रियाहरु जब मजबुत र फलदायी हुदैनन तब सम्म नागरिक तथा सामाजिक संगठनहरुले प्रभाकारी र रचनात्मक भूमिका निर्वाह गर्न सक्दैनन् ।
      </>
    )
  },
  
  {
    ...
    quote: (
      <>
        हाम्रो अभियान भनेको महिलाहरूलाई आर्थिक र सामाजिक रूपमा सक्षम बनाउनु हो। जबसम्म <span className="bg-core-blue px-1 text-white">महिला नेतृत्व</span> समाजको हरेक तहमा पुग्दैन, तबसम्म वास्तविक विकास सम्भव छैन। हामीले स्थानीय स्रोत र साधनको अधिकतम परिचालन गर्दै समुदायमा सकारात्मक परिवर्तन ल्याउने प्रयास गरिरहेका छौं।
      </>
    )
  },
];
