...
export default function StoryDetailPage() {
  ...
  useEffect(() => {
    const loadStory = async () => {
      ...
      const foundStory = successStories.find(s => generateSlug(s.title) === slug);
          ...
          <div className="grid lg:grid-cols-2 gap-8 p-8">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="text-gray-700 leading-relaxed mb-6">
                <p className="text-lg">{story.description.split('\n\n')[0]}</p>
              </div>
            </div>
          </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {relatedStories.map((relatedStory) => (
                  <div key={relatedStory.id} className="group">
                    <Link href={`/success-story/${generateSlug(relatedStory.title)}`}>
