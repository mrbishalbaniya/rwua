...
function GalleryPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GalleryPage.useEffect": ()=>{
            ...
            __turbopack_context__.A("[project]/node_modules/gsap/dist/Flip.js [app-client] (ecmascript, async loader)").then({
                "GalleryPage.useEffect": ({ Flip })=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].registerPlugin(Flip);
                    const items = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].utils.toArray(".gallery-item");
                    ...
                    let activeItem;
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].set(detailContent, {
                        yPercent: -100
                    });
                    function showDetails(item) {
                        ...
                        let onLoad = {
                            "GalleryPage.useEffect.showDetails.onLoad": ()=>{
                                Flip.fit(details, item, {
                                    scale: true,
                                    fitChild: detailImage
                                });
                                const state = Flip.getState(details);
                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].set(details, {
                                    clearProps: true
                                });
                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].set(details, {
                                    xPercent: -50,
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].to(items, {
                            opacity: 0.3,
                            stagger: {
                                amount: 0.7,
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].to(".gallery-app", {
                    ...
                    function hideDetails() {
                        ...
                        Flip.from(state, {
                            ...
                            delay: 0.2,
                            onInterrupt: {
                                "GalleryPage.useEffect.hideDetails": ()=>{
                                    tl.kill();
                                }
                            }["GalleryPage.useEffect.hideDetails"]
                        }).set(details, {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].utils.toArray('.gallery-item').forEach({
                        "GalleryPage.useEffect": (item)=>item.addEventListener('click', {
                                "GalleryPage.useEffect": ()=>showDetails(item)
                            }["GalleryPage.useEffect"])
                    }["GalleryPage.useEffect"]);
                }
            }["GalleryPage.useEffect"]);
