      ...
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-32">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="mt-16">
              <button className="bg-deep-purple text-vibrant-gold font-black py-5 px-12 rounded-2xl text-[10px] tracking-[0.3em] uppercase hover:bg-black transition-all shadow-2xl active:scale-95">
